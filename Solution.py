...
def compare_function(client1,client2,info):
    """
        Those with lower tolerance will have higher priority.
    """
...
class Solution:
    ...
    def output_paths(self):
        ...
        for node,value in bandwidth_use_max.items():
            ...
            if bandwidth_use_max[node] > len(self.info["list_clients"]) * 0.04:
                ...
                bandwidths[node] += int(bandwidth_use_max[node]*0.4)
        ...
        # (more than 2% of the total clients) and increases their available bandwidth by 20%. 
